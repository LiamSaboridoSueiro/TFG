"""
Script de entrenamiento all-subjects alpha_beta_language:
...
Salida:
  scripts/tests/alpha_beta_language/results/all_subjects/all_subjects_results.json       metricas e hiperparametros por clasificador
  scripts/tests/alpha_beta_language/results/all_subjects/01_cv_scores_<clf>.png          metricas CV del mejor clasificador
  scripts/tests/alpha_beta_language/results/all_subjects/02_confusion_<clf>.png          matriz de confusion agregada
  scripts/tests/alpha_beta_language/results/all_subjects/03_importancia_<clf>.png        importancia de features
  scripts/tests/alpha_beta_language/models/all_subjects/global_model.joblib              modelo final global
...
# ---------------------------------------------------------------------- Configuracion
RESULTS_DIR = TEST_DIR / "results" / "all_subjects"
FINAL_MODEL_PATH = TEST_DIR / "models" / "all_subjects" / "global_model.joblib"
...
if __name__ == "__main__":
    ...
    print("Terminado - resultados en scripts/tests/alpha_beta_language/results/all_subjects/")
