...
Salida:
  ...
  scripts/tests/alpha_beta_language/results/shap_topomap/shap_feature_importance_by_subject.csv
  scripts/tests/alpha_beta_language/results/shap_topomap/shap_feature_importance.csv
  scripts/tests/alpha_beta_language/results/shap_topomap/shap_channel_band_importance.csv
  scripts/tests/alpha_beta_language/results/shap_topomap/shap_band_importance.csv
  scripts/tests/alpha_beta_language/results/shap_topomap/shap_cluster_band_importance.csv
  scripts/tests/alpha_beta_language/results/shap_topomap/explicability_summary.json
  scripts/tests/alpha_beta_language/results/shap_topomap/01_top_features_global.png
  scripts/tests/alpha_beta_language/results/shap_topomap/02_band_importance_by_class.png
  scripts/tests/alpha_beta_language/results/shap_topomap/03_topomap_abs_<COND>.png
  scripts/tests/alpha_beta_language/results/shap_topomap/04_topomap_signed_<COND>.png
  scripts/tests/alpha_beta_language/results/shap_topomap/05_cluster_importance_by_class.png
  scripts/tests/alpha_beta_language/results/shap_topomap/06_cluster_band_heatmap.png
  scripts/tests/alpha_beta_language/results/topomaps_subjects/topomap_abs_<SUBJECT>.png
  scripts/tests/alpha_beta_language/results/topomaps_subjects/topomap_signed_<SUBJECT>.png
"""
...
METRIC_COL_WIDTH = 12
SUBJECT_TOPOMAP_DIR = RESULTS_DIR / "topomaps_subjects"
