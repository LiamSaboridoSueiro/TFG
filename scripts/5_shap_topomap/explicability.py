...
Salida:
  results/shap_topomap/within_subject/shap_subject_summary.csv
  ...
  results/shap_topomap/within_subject/shap_cluster_band_importance.csv
  ...
  results/shap_topomap/within_subject/05_cluster_importance_by_class.png
  results/shap_topomap/within_subject/06_cluster_band_heatmap.png
  results/shap_topomap/within_subject/topomaps_subjects/topomap_abs_<SUBJECT>.png
  results/shap_topomap/within_subject/topomaps_subjects/topomap_signed_<SUBJECT>.png
"""
...
# Permite ejecutar este script desde scripts/5_shap_topomap importando
