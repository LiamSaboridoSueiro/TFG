...
En este capítulo se presentan los resultados obtenidos durante la evaluación del sistema. Se analizan las representaciones generadas a partir de las características extraídas, el comportamiento de los clasificadores entrenados y las explicaciones asociadas a sus predicciones, con el objetivo de valorar la capacidad del sistema para diferenciar las condiciones emocionales estudiadas.
...
\begin{figure}[H]
    ...
    \caption{\acs{PCA} global del espacio de características coloreada por condición emocional.}
...
\begin{figure}[H]
    ...
    \caption{\acs{PCA} global del espacio de características coloreada por sujeto.}
...
\begin{figure}[H]
    ...
    \caption{\acs{LDA} global del espacio de características coloreada por condición emocional.}
...
\begin{figure}[H]
    ...
    \caption{\acs{LDA} global del espacio de características coloreada por sujeto.}
...
\begin{figure}[H]
    ...
    \end{minipage}
    \caption{\acs{PCA} dentro de sujeto para dos participantes.}
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \small Sujeto 211-000552
    \end{minipage}
    \caption{\acs{LDA} dentro de sujeto para dos participantes.}
...
Una vez estudiada la separabilidad del espacio de características, se evaluaron los dos clasificadores utilizados en el sistema: regresión logística y árbol de decisión. En ambos casos se empleó el mismo conjunto de entrada utilizado en el análisis anterior. La evaluación se realizó en dos escenarios: \textit{all-subjects}, donde se entrena un modelo común separando los sujetos entre \textit{folds}, y \textit{within-subject}, donde cada participante se evalúa de forma independiente.
...
El árbol de decisión fue el mejor clasificador en el escenario \textit{all-subjects}, aunque la mejora respecto a la regresión logística fue pequeña. Obtuvo una exactitud media de 0,358 y un \textit{F1-score} macro de 0,346. La matriz de confusión de la Figura~\ref{fig:confusion_tree_all} muestra una distribución algo más equilibrada que la de la regresión logística, sin un sesgo tan fuerte hacia una única clase, pero la diagonal sigue siendo débil: los aciertos por clase se mantienen entre 0,33 y 0,39. Por tanto, aunque este clasificador sea ligeramente superior en el modelo común, el rendimiento continúa siendo bajo.
...
\begin{figure}[H]
    ...
    \caption{Características con mayor importancia media absoluta según \acs{SHAP} en el modelo \textit{within-subject}.}
...
Los mapas topográficos con signo permiten observar dónde contribuyen más las características hacia cada clase. En estas figuras, los colores rojizos representan contribuciones positivas hacia la emoción indicada y los azulados contribuciones negativas. Al estar basados en \ac{SHAP}, no muestran potencia cerebral absoluta, sino cómo las características de cada zona empujan la decisión del modelo hacia una clase concreta.
...
\begin{figure}[H]
    ...
    \caption{Topomap con signo de \acs{SHAP} para la clase \texttt{JOY}.}
...
\begin{figure}[H]
    ...
    \caption{Topomap con signo de \acs{SHAP} para la clase \texttt{NEUTRO}.}
...
\begin{figure}[H]
    ...
    \caption{Topomap con signo de \acs{SHAP} para la clase \texttt{SAD}.}
    \label{fig:topomap_signed_sad}
\end{figure}

\subsection{Diferencias entre sujetos}

La explicabilidad también confirma que los patrones no son idénticos entre participantes. Las Figuras~\ref{fig:topomap_subject_547_552} muestran los topomaps con signo de los sujetos 211-000547 y 211-000552, dos participantes que ya se habían utilizado como ejemplo en el análisis de separabilidad. Ambos obtienen buen rendimiento en el modelo \textit{within-subject}, pero la distribución espacial de las contribuciones no es igual.
...
\begin{figure}[H]
    ...
    \begin{minipage}{0.48\textwidth}
        ...
        \small Sujeto 211-000552
    \end{minipage}
    \caption{Topomaps con signo por sujeto para dos participantes representativos.}
...
Habiendo analizado los resultados del sistema y su interpretación, en el siguiente capítulo se detallarán las conclusiones principales del trabajo, sus limitaciones y las posibles líneas futuras.
