...
\begin{figure}[H]
    ...
    \caption{Topomap firmado de \acs{SHAP} para la clase \texttt{JOY}.}
...
\begin{figure}[H]
    ...
    \caption{Topomap firmado de \acs{SHAP} para la clase \texttt{NEUTRO}.}
...
\begin{figure}[H]
    ...
    \caption{Topomap firmado de \acs{SHAP} para la clase \texttt{SAD}.}
