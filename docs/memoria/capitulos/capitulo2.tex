...
La metodología seguida en este trabajo se ha organizado de forma progresiva, comenzando por una revisión de la literatura relacionada con el reconocimiento de emociones mediante señales de \ac{EEG}, el preprocesado de este tipo de señales, la extracción de características y el uso de modelos interpretables. Esta revisión permitió entender mejor el problema y tomar decisiones sobre las técnicas más adecuadas para aplicar en el desarrollo del trabajo.

Una vez situado el contexto, se llevó a cabo un análisis inicial del conjunto de datos proporcionado por el tutor, el cual fue registrado previamente con sujetos reales. En esta fase se estudió la estructura de los datos, los sujetos disponibles, las clases emocionales consideradas y la forma en la que estaban organizadas las señales. A partir de este análisis, se prepararon los datos para poder trabajar con ellos de forma adecuada en las siguientes fases.

Se realizó el preprocesado de las señales de \ac{EEG}, con el objetivo de preparar los datos antes de su análisis. Después se llevó a cabo la extracción de características, teniendo en cuenta información procedente de distintos canales y bandas espectrales. Estas características fueron utilizadas como entrada para los modelos de aprendizaje automático.

Antes del entrenamiento de los modelos, se aplicaron técnicas de análisis de datos y algoritmos de separabilidad para estudiar si las características extraídas permitían diferenciar entre las emociones consideradas. Esta fase sirvió para comprender mejor la distribución de los datos y valorar qué información podía ser más útil para la clasificación.

Finalmente, se entrenaron y evaluaron distintos clasificadores, comparando su rendimiento y analizando sus resultados. Además de estudiar la capacidad de los modelos para clasificar las emociones, también se prestó atención a la interpretabilidad, con el objetivo de entender qué características, canales o bandas tenían mayor influencia en las decisiones tomadas por los modelos.

\section{Planificación y seguimiento}

La planificación del trabajo se organizó en distintas tareas principales: revisión bibliográfica, análisis del conjunto de datos, preprocesado de las señales, extracción de características, análisis de separabilidad, entrenamiento de modelos e interpretación de los resultados. Esta división permitió avanzar de forma ordenada y controlar mejor el progreso del proyecto.

El seguimiento del trabajo se realizó mediante revisiones semanales con el tutor. En ellas comentaba los avances realizados, se resolvían dudas y se validaban las decisiones tomadas en cada fase. El proceso seguido consistía primero en leer y estudiar la información necesaria para ubicarme en cada parte del proyecto; después, comentar con el tutor las ideas aprendidas y el plan de acción propuesto; y, finalmente, implementar la solución y corregirla en función de los resultados obtenidos y del feedback recibido.

Para organizar las tareas se siguió una metodología inspirada en el método \textit{Getting Things Done}. Las tareas se dividieron en acciones concretas y manejables, de forma que cada fase del trabajo tuviera objetivos claros. Así, el proyecto fue avanzando por bloques: primero el preprocesado, después la extracción de características, el análisis de separabilidad, el entrenamiento de modelos y, por último, la interpretación y documentación de los resultados.

Esta forma de trabajo permitió mantener un seguimiento continuo del proyecto, detectar problemas de forma temprana y ajustar el planteamiento cuando fue necesario. Además, las reuniones periódicas ayudaron a comprobar que cada decisión técnica estuviera alineada con los objetivos del trabajo.